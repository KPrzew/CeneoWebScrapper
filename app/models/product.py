...
class Product:
    ...
    def draw_charts(self): 
        ...
        plt.close()
        score = self.opinions_do_df().score.value_counts().sort_index().reindex(list(np.arange(0,5.5,0.5)), fill_value=0)
        score.plot.bar()
        ...
        plt.savefig(f"app/static/plots/{self.product_id}_score.png")
        plt.close()
